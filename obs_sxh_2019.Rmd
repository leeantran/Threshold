---
title: "Phân tích dữ liệu SXH đợt dịch 2019"
output:
...
```{r}
control <- list(b = 3, w = 3, range = 160:208, reweight = T, verbose = F)
...
control <- list(b = 3, w = 3, range = 160:208, reweight = T, weightsTreshold = 2.58,
...
```{r}
control <- list(range = 160:208, k = 1.04, h = 2.26)
...
control <- list(range = 160:208, k = 1.04, h = 2.26, trans = "rossi")
...
control <- list(range = 160:208, k = 1.04, h = 2.26, m = "glm", trans = "rossi")
...
control <- list(range = 160:208, k = 1.04, h = 2.26, trans = "pearsonNegBin")
...
control <- list(range = 160:208, k = 1.04, h = 2.26, m = "glm", trans = "pearsonNegBin")
...
```{r}
control <- list(range = 160:208, actY = F,
                b = 3, w = 3)
...
```{r}
control <- list(range = 160:208, c.ARL = 5, dir = "inc")
...
dff_mem <- dff[,c(3,4,5)] # Lấy dữ liệu 2017 - 2021 (5 năm) 
...
dff <- dff %>%
  mutate(outbreak = ifelse(y_2019 > threshold, 1, 0),
         outbreak_mem = ifelse(y_2019 > threshold_mem, 1, 0))
...
saveRDS(tbl, "tbl_tp_sxh_2019.rds")
```
...
control <- list(range = 160:208, method = "C2", baseline = 3, alpha = 0.05)
c2 <- earsC(stsObj, control = control)
plot(c2, main = "EARS C2 method", xlab = "Epi week", ylab = "Number of Cases")

control <- list(range = 160:208, method = "C3", baseline = 3, alpha = 0.05)
c3 <- earsC(stsObj, control = control)
plot(c3, main = "EARS C3 method", xlab = "Epi week", ylab = "Number of Cases")
```
...
tbl <- data.frame(method, spec, sens, fpr, ppv, npv)
saveRDS(tbl, "tbl_q1_sxh_2019.rds")
```
...
tbl <- data.frame(method, spec, sens, fpr, ppv, npv)
saveRDS(tbl, "tbl_q3_sxh_2019.rds")
```
...
tbl <- data.frame(method, spec, sens, fpr, ppv, npv)
saveRDS(tbl, "tbl_q4_sxh_2019.rds")
```
...
tbl <- data.frame(method, spec, sens, fpr, ppv, npv)
saveRDS(tbl, "tbl_q5_sxh_2019.rds")
```
...
tbl <- data.frame(method, spec, sens, fpr, ppv, npv)
saveRDS(tbl, "tbl_q6_sxh_2019.rds")
```
...
tbl <- data.frame(method, spec, sens, fpr, ppv, npv)
saveRDS(tbl, "tbl_q7_sxh_2019.rds")
```
...
tbl <- data.frame(method, spec, sens, fpr, ppv, npv)
saveRDS(tbl, "tbl_q8_sxh_2019.rds")
```
...
tbl <- data.frame(method, spec, sens, fpr, ppv, npv)
saveRDS(tbl, "tbl_q10_sxh_2019.rds")
```
...
tbl <- data.frame(method, spec, sens, fpr, ppv, npv)
saveRDS(tbl, "tbl_q11_sxh_2019.rds")
```
...
tbl <- data.frame(method, spec, sens, fpr, ppv, npv)
saveRDS(tbl, "tbl_q12_sxh_2019.rds")
```
...
tbl <- data.frame(method, spec, sens, fpr, ppv, npv)
saveRDS(tbl, "tbl_gv_sxh_2019.rds")
```
...
tbl <- data.frame(method, spec, sens, fpr, ppv, npv)
saveRDS(tbl, "tbl_tb_sxh_2019.rds")
```
...
tbl <- data.frame(method, spec, sens, fpr, ppv, npv)
saveRDS(tbl, "tbl_bt_sxh_2019.rds")
```
...
tbl <- data.frame(method, spec, sens, fpr, ppv, npv)
saveRDS(tbl, "tbl_pn_sxh_2019.rds")
```
...
tbl <- data.frame(method, spec, sens, fpr, ppv, npv)
saveRDS(tbl, "tbl_cc_sxh_2019.rds")
```
...
tbl <- data.frame(method, spec, sens, fpr, ppv, npv)
saveRDS(tbl, "tbl_hm_sxh_2019.rds")
```
...
tbl <- data.frame(method, spec, sens, fpr, ppv, npv)
saveRDS(tbl, "tbl_bc_sxh_2019.rds")
```
...
tbl <- data.frame(method, spec, sens, fpr, ppv, npv)
saveRDS(tbl, "tbl_nb_sxh_2019.rds")
```
...
tbl <- data.frame(method, spec, sens, fpr, ppv, npv)
saveRDS(tbl, "tbl_tptd_sxh_2019.rds")
```
...
tbl <- data.frame(method, spec, sens, fpr, ppv, npv)
saveRDS(tbl, "tbl_cg_sxh_2019.rds")
```
...
tbl <- data.frame(method, spec, sens, fpr, ppv, npv)
saveRDS(tbl, "tbl_tphu_sxh_2019.rds")
```
...
tbl <- data.frame(method, spec, sens, fpr, ppv, npv)
saveRDS(tbl, "tbl_bta_sxh_2019.rds")
```