---
title: "Phân tích dữ liệu TCM đợt dịch 2018"
output:
...
df_raw$yw <- paste0(df_raw$nam, df_raw$t)
...
```{r}
control <- list(b = 2, w = 3, range = 108:156, reweight = T, verbose = F)
...
control <- list(b = 2, w = 3, range = 108:156, reweight = T, weightsTreshold = 2.58,
...
```{r}
control <- list(range = 108:156, k = 1.04, h = 2.26)
...
control <- list(range = 108:156, k = 1.04, h = 2.26, trans = "rossi")
...
control <- list(range = 108:156, k = 1.04, h = 2.26, m = "glm", trans = "rossi")
...
control <- list(range = 108:156, k = 1.04, h = 2.26, trans = "pearsonNegBin")
...
control <- list(range = 108:156, k = 1.04, h = 2.26, m = "glm", trans = "pearsonNegBin")
...
```{r}
control <- list(range = 108:156, actY = F,
                b = 2, w = 3)
...
```{r}
control <- list(range = 108:156, c.ARL = 5, dir = "inc")
...
dff_mem <- dff[,c(3,4)] # Lấy dữ liệu 2017 - 2021 (5 năm) 
...
dff <- dff %>%
  mutate(outbreak = ifelse(y_2018 > threshold, 1, 0),
         outbreak_mem = ifelse(y_2018 > threshold_mem, 1, 0))
...
saveRDS(tbl, "tbl_tp_tcm_2018.rds")
```
...
tbl <- data.frame(method, spec, sens, fpr, ppv, npv)
saveRDS(tbl, "tbl_q1_tcm_2018.rds")
```
...
tbl <- data.frame(method, spec, sens, fpr, ppv, npv)
saveRDS(tbl, "tbl_q3_tcm_2018.rds")
```
...
tbl <- data.frame(method, spec, sens, fpr, ppv, npv)
saveRDS(tbl, "tbl_q4_tcm_2018.rds")
```
...
tbl <- data.frame(method, spec, sens, fpr, ppv, npv)
saveRDS(tbl, "tbl_q5_tcm_2018.rds")
```
...
tbl <- data.frame(method, spec, sens, fpr, ppv, npv)
saveRDS(tbl, "tbl_q6_tcm_2018.rds")
```
...
tbl <- data.frame(method, spec, sens, fpr, ppv, npv)
saveRDS(tbl, "tbl_q7_tcm_2018.rds")
```
...
tbl <- data.frame(method, spec, sens, fpr, ppv, npv)
saveRDS(tbl, "tbl_q8_tcm_2018.rds")
```
...
tbl <- data.frame(method, spec, sens, fpr, ppv, npv)
saveRDS(tbl, "tbl_q10_tcm_2018.rds")
```
...
tbl <- data.frame(method, spec, sens, fpr, ppv, npv)
saveRDS(tbl, "tbl_q11_tcm_2018.rds")
```
...
tbl <- data.frame(method, spec, sens, fpr, ppv, npv)
saveRDS(tbl, "tbl_q12_tcm_2018.rds")
```
...
tbl <- data.frame(method, spec, sens, fpr, ppv, npv)
saveRDS(tbl, "tbl_gv_tcm_2018.rds")
```
...
tbl <- data.frame(method, spec, sens, fpr, ppv, npv)
saveRDS(tbl, "tbl_tb_tcm_2018.rds")
```
...
tbl <- data.frame(method, spec, sens, fpr, ppv, npv)
saveRDS(tbl, "tbl_bt_tcm_2018.rds")
```
...
npv <- c(m1$TN/(m1$TN+m1$FN), m2$TN/(m2$TN+m2$FN), m3$TN/(m3$TN+m3$FN), 
         ...
         m18$byClass["Neg Pred Value"])
tbl <- data.frame(method, spec, sens, fpr, ppv, npv)
saveRDS(tbl, "tbl_pn_tcm_2018.rds")
```
...
tbl <- data.frame(method, spec, sens, fpr, ppv, npv)
saveRDS(tbl, "tbl_cc_tcm_2018.rds")
```
...
tbl <- data.frame(method, spec, sens, fpr, ppv, npv)
saveRDS(tbl, "tbl_hm_tcm_2018.rds")
```
...
tbl <- data.frame(method, spec, sens, fpr, ppv, npv)
saveRDS(tbl, "tbl_bc_tcm_2018.rds")
```
...
tbl <- data.frame(method, spec, sens, fpr, ppv, npv)
saveRDS(tbl, "tbl_nb_tcm_2018.rds")
```
...
tbl <- data.frame(method, spec, sens, fpr, ppv, npv)
saveRDS(tbl, "tbl_tptd_tcm_2018.rds")
```
...
tbl <- data.frame(method, spec, sens, fpr, ppv, npv)
saveRDS(tbl, "tbl_cg_tcm_2018.rds")
```
...
tbl <- data.frame(method, spec, sens, fpr, ppv, npv)
saveRDS(tbl, "tbl_tphu_tcm_2018.rds")
```
...
tbl <- data.frame(method, spec, sens, fpr, ppv, npv)
saveRDS(tbl, "tbl_bta_tcm_2018.rds")
```