---
title: "Phân tích dữ liệu TCM đợt dịch 2023"
output:
...
# MEM <- function(data, total_column, year_column, week_column, lambda, year_to_predict, k = 2) {
# 
...
#     mutate(
#       outbreak_MEM = ifelse(!!sym(total_column) > upper_bound, 1, 0)
#     )
#   
#   
#   result <- bind_rows(
#     training_data %>% select(-MEM),
#     prediction_data
#   )
#   
#   return(result)
...
```{r}
df_raw <- read_xlsx("Data/data_raw.xlsx", sheet = "tcm")

df_raw$total[df_raw$nam == 2018] <- df_raw$mean[df_raw$nam == 2018]
...
```{r}
control <- list(b = 5, w = 3, range = 365:416, reweight = T, verbose = F)
...
control <- list(b = 5, w = 3, range = 365:416, reweight = T, weightsTreshold = 2.58,
...
```{r}
control <- list(range = 365:416, k = 1.04, h = 2.26)
...
control <- list(range = 365:416, k = 1.04, h = 2.26, trans = "rossi")
...
control <- list(range = 365:416, k = 1.04, h = 2.26, m = "glm", trans = "rossi")
...
control <- list(range = 365:416, k = 1.04, h = 2.26, trans = "pearsonNegBin")
...
control <- list(range = 365:416, k = 1.04, h = 2.26, m = "glm", trans = "pearsonNegBin")
...
```{r}
control <- list(range = 365:416, actY = F,
                b = 5, w = 3)
...
```{r}
control <- list(range = 365:416, c.ARL = 5, dir = "inc")
...
```{r}
dff <- filter(df, nam <= 2023 & nam > 2017) 
...
dff <- dff %>%
  mutate(outbreak = ifelse(y_2023 > threshold, 1, 0),
         outbreak_mem = ifelse(y_2023 > threshold_mem, 1, 0))
...
saveRDS(tbl, "tbl_tp_tcm_2023.rds")
```
...
df_raw$total[df_raw$nam == 2018] <- df_raw$m_q1[df_raw$nam == 2018]
...
tbl <- data.frame(method, spec, sens, fpr, ppv, npv)
saveRDS(tbl, "tbl_q1_tcm_2023.rds")
```
...
df_raw$total[df_raw$nam == 2018] <- df_raw$m_q3[df_raw$nam == 2018]
...
tbl <- data.frame(method, spec, sens, fpr, ppv, npv)
saveRDS(tbl, "tbl_q3_tcm_2023.rds")
```
...
df_raw$total[df_raw$nam == 2018] <- df_raw$m_q4[df_raw$nam == 2018]
...
tbl <- data.frame(method, spec, sens, fpr, ppv, npv)
saveRDS(tbl, "tbl_q4_tcm_2023.rds")
```
...
df_raw$total[df_raw$nam == 2018] <- df_raw$m_q5[df_raw$nam == 2018]
...
tbl <- data.frame(method, spec, sens, fpr, ppv, npv)
saveRDS(tbl, "tbl_q5_tcm_2023.rds")
```
...
df_raw$total[df_raw$nam == 2018] <- df_raw$m_q6[df_raw$nam == 2018]
...
tbl <- data.frame(method, spec, sens, fpr, ppv, npv)
saveRDS(tbl, "tbl_q6_tcm_2023.rds")
```
...
df_raw$total[df_raw$nam == 2018] <- df_raw$m_q7[df_raw$nam == 2018]
...
tbl <- data.frame(method, spec, sens, fpr, ppv, npv)
saveRDS(tbl, "tbl_q7_tcm_2023.rds")
```
...
df_raw$total[df_raw$nam == 2018] <- df_raw$m_q8[df_raw$nam == 2018]
...
tbl <- data.frame(method, spec, sens, fpr, ppv, npv)
saveRDS(tbl, "tbl_q8_tcm_2023.rds")
```
...
df_raw$total[df_raw$nam == 2018] <- df_raw$m_q10[df_raw$nam == 2018]
...
tbl <- data.frame(method, spec, sens, fpr, ppv, npv)
saveRDS(tbl, "tbl_q10_tcm_2023.rds")
```
...
df_raw$total[df_raw$nam == 2018] <- df_raw$m_q11[df_raw$nam == 2018]
...
bayes1 <- algo.bayes1(disProgObj, control = control)
plot(rki1, main = "Bayes 1 method", xlab = "Epi week", ylab = "Number of Cases")

bayes2 <- algo.bayes2(disProgObj, control = control)
plot(rki2, main = "Bayes 2 method", xlab = "Epi week", ylab = "Number of Cases")

# bayes3 <- algo.bayes3(disProgObj, control = control)
# plot(rki3, main = "Bayes 3 method", xlab = "Epi week", ylab = "Number of Cases")
```
...
tbl <- data.frame(method, spec, sens, fpr, ppv, npv)
saveRDS(tbl, "tbl_q11_tcm_2023.rds")
```
...
df_raw$total[df_raw$nam == 2018] <- df_raw$m_q12[df_raw$nam == 2018]
...
tbl <- data.frame(method, spec, sens, fpr, ppv, npv)
saveRDS(tbl, "tbl_q12_tcm_2023.rds")
```
...
df_raw$total[df_raw$nam == 2018] <- df_raw$m_gv[df_raw$nam == 2018]
...
tbl <- data.frame(method, spec, sens, fpr, ppv, npv)
saveRDS(tbl, "tbl_gv_tcm_2023.rds")
```
...
df_raw$total[df_raw$nam == 2018] <- df_raw$m_tb[df_raw$nam == 2018]
...
tbl <- data.frame(method, spec, sens, fpr, ppv, npv)
saveRDS(tbl, "tbl_tb_tcm_2023.rds")
```
...
df_raw$total[df_raw$nam == 2018] <- df_raw$m_bt[df_raw$nam == 2018]
...
tbl <- data.frame(method, spec, sens, fpr, ppv, npv)
saveRDS(tbl, "tbl_bt_tcm_2023.rds")
```
...
df_raw$total[df_raw$nam == 2018] <- df_raw$m_pn[df_raw$nam == 2018]
...
tbl <- data.frame(method, spec, sens, fpr, ppv, npv)
saveRDS(tbl, "tbl_pn_tcm_2023.rds")
```
...
df_raw$total[df_raw$nam == 2018] <- df_raw$m_cc[df_raw$nam == 2018]
...
tbl <- data.frame(method, spec, sens, fpr, ppv, npv)
saveRDS(tbl, "tbl_cc_tcm_2023.rds")
```
...
df_raw$total[df_raw$nam == 2018] <- df_raw$m_hm[df_raw$nam == 2018]
...
tbl <- data.frame(method, spec, sens, fpr, ppv, npv)
saveRDS(tbl, "tbl_hm_tcm_2023.rds")
```
...
df_raw$total[df_raw$nam == 2018] <- df_raw$m_bc[df_raw$nam == 2018]
...
tbl <- data.frame(method, spec, sens, fpr, ppv, npv)
saveRDS(tbl, "tbl_bc_tcm_2023.rds")
```
...
df_raw$total[df_raw$nam == 2018] <- df_raw$m_nb[df_raw$nam == 2018]
...
tbl <- data.frame(method, spec, sens, fpr, ppv, npv)
saveRDS(tbl, "tbl_nb_tcm_2023.rds")
```
...
df_raw$total[df_raw$nam == 2018] <- df_raw$m_tptd[df_raw$nam == 2018]
...
tbl <- data.frame(method, spec, sens, fpr, ppv, npv)
saveRDS(tbl, "tbl_tptd_tcm_2023.rds")
```
...
df_raw$total[df_raw$nam == 2018] <- df_raw$m_cg[df_raw$nam == 2018]
...
tbl <- data.frame(method, spec, sens, fpr, ppv, npv)
saveRDS(tbl, "tbl_cg_tcm_2023.rds")
```
...
df_raw$total[df_raw$nam == 2018] <- df_raw$m_tp[df_raw$nam == 2018]
...
tbl <- data.frame(method, spec, sens, fpr, ppv, npv)
saveRDS(tbl, "tbl_tphu_tcm_2023.rds")
```
...
df_raw$total[df_raw$nam == 2018] <- df_raw$m_bta[df_raw$nam == 2018]
...
tbl <- data.frame(method, spec, sens, fpr, ppv, npv)
saveRDS(tbl, "tbl_bta_tcm_2023.rds")
```